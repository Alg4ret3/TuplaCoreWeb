...
import { 
  Globe, Smartphone, Code2, Lightbulb, 
  ArrowRight, ArrowLeft, CheckCircle2,
  Calendar, DollarSign, User, Mail, Building
} from 'lucide-react';
...
const services = [
  ...
  { id: 'mobile', title: 'Apps Móviles', icon: Smartphone, color: 'blue' },
  { id: 'software', title: 'Software a Medida', icon: Code2, color: 'purple' },
  { id: 'consulting', title: 'Consultoría IT', icon: Lightbulb, color: 'amber' },
];
      ...
      <div className="relative z-10 max-w-4xl mx-auto pt-40 pb-32 px-6">
        ...
        >
          ...
          <p className="text-gray-500 dark:text-gray-400 text-lg md:text-xl font-light max-w-2xl mx-auto">
            Ayúdanos a entender tu visión y te daremos las herramientas para hacerla realidad.
          </p>
        </motion.div>
          ...
          <AnimatePresence mode="wait">
            ...
            {step === 1 && (
              <motion.div key="step1" {...fadeInUp} className="space-y-8">
                <div className="text-center space-y-2">
                  <h2 className="text-2xl font-bold uppercase tracking-tight italic">¿Qué necesitas construir?</h2>
                  <p className="text-sm text-gray-400">Selecciona el tipo de solución que buscas.</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {services.map((s) => {
                        ...
                        return (
                          ...
                          >
                            <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 transition-transform group-hover:scale-110 ${bgMap[s.color]}`}>
            ...
            {step === 2 && (
              <motion.div key="step2" {...fadeInUp} className="space-y-8">
                <div className="space-y-2">
                  <h2 className="text-2xl font-bold uppercase tracking-tight italic">Cuéntanos más</h2>
                  <p className="text-sm text-gray-400">Describe brevemente tu idea o los objetivos principales.</p>
                </div>
                <Textarea 
                  placeholder="Ej: Necesito un e-commerce para venta de calzado con integración de pagos..."
            ...
            {step === 3 && (
              <motion.div key="step3" {...fadeInUp} className="space-y-8">
                <div className="space-y-2">
                  <h2 className="text-2xl font-bold uppercase tracking-tight italic">Alcance Estimado</h2>
                  <p className="text-sm text-gray-400">Esto nos ayuda a priorizar y proponer tecnologías adecuadas.</p>
                </div>
                
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="space-y-4">
                    <label className="text-[0.65rem] font-bold uppercase tracking-widest text-gray-500 flex items-center">
                      <DollarSign size={12} className="mr-2" /> Presupuesto Estimado
                    </label>
                  ...
                  <div className="space-y-4">
                    <label className="text-[0.65rem] font-bold uppercase tracking-widest text-gray-500 flex items-center">
                      <Calendar size={12} className="mr-2" /> Tiempo de Entrega
                    </label>
            ...
            {step === 4 && (
              <motion.div key="step4" {...fadeInUp} className="space-y-8">
                <div className="space-y-2 text-center mb-8">
                  <h2 className="text-2xl font-bold uppercase tracking-tight italic">Información de Contacto</h2>
                  <p className="text-sm text-gray-400">¿A quién dirigimos nuestra propuesta?</p>
                </div>
