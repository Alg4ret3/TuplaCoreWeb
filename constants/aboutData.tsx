...
export const team = [
  ...
  },
  {
    ...
    bio: "Interfaces de alto rendimiento centradas en el usuario. Dominio profundo del ecosistema React para web y aplicaciones móviles nativas.",
    accentColor: "#18d4aa",
    accentBg: "rgba(24,212,170,0.12)",
    accentBorder: "rgba(24,212,170,0.3)",
    glowColor: "rgba(24,212,170,0.2)",
    skills: [
      { name: "Frontend", pct: 95 },
      { name: "Mobile", pct: 90 },
      { name: "UI / UX", pct: 82 },
      { name: "Next.js", pct: 93 },
    ],
    chips: ["Next.js", "TypeScript", "React Native", "CSS", "JavaScript"],
  },
];
