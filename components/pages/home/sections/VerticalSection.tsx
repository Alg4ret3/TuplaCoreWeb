...
const VerticalSection = forwardRef<HTMLElement>((_, ref) => {
  return (
    <section
      id="section-2"
      ref={ref}
      className="relative z-20 bg-[#111111] h-auto w-full flex flex-col items-center justify-center overflow-hidden font-inter border-y border-white/5"
    >
      ...
      <div className="relative z-20 w-full max-w-5xl mx-auto px-4 sm:px-6 py-20 pointer-events-none">
        <m.div
        ...
        <div className="pointer-events-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {painPoints.map((point, index) => (
              <m.div
                ...
                viewport={{ once: true }}
                className="bg-black/40 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:border-[#7F77DD]/30 transition-colors"
              >
          ...
          <m.p
            ...
            viewport={{ once: true }}
            className="text-white/60 text-center mt-12 font-inter text-sm"
          >
